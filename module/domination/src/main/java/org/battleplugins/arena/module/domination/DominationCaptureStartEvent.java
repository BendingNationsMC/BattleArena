...
/**
 * Event fired when a team begins capturing a domination area.
 */
@EventTrigger("domination-capture-start")
public class DominationCaptureStartEvent extends Event implements ArenaEvent {
    ...
    public DominationCaptureStartEvent(
            Arena arena,
